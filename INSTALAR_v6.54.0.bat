...
if !CUANTOS!==0 (
  ...
  echo      Deja "control-bolsas-v6.54.0.zip" en esta misma carpeta.
  pause & exit /b 1
)
if !CUANTOS! GTR 1 (
  echo.
...
set "TMPDIR=%TEMP%\cb_v654_%RANDOM%"
...
echo.
echo  ============================================================
echo    v6.54.0 INSTALADA  -  CICLO 11
echo.
