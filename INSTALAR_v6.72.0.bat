...
title Control Bolsas - Instalar v6.72.0 - Ciclo 7
color 0B
cls
echo.
echo  ============================================================
echo    INSTALAR v6.72.0  -  CICLO 11 (carga inicial)
echo  ============================================================
echo.
echo   Este instalador NO BORRA NADA. Lo unico que hace es:
echo     - respaldar tu proyecto completo antes de tocar un archivo
echo     - copiar el proyecto v6.72.0 completo
...
if !CUANTOS!==0 (
  ...
  echo      Deja "control-bolsas-v6.72.0.zip" en esta misma carpeta.
  pause & exit /b 1
)
if !CUANTOS! GTR 1 (
  echo.
...
set "TMPDIR=%TEMP%\cb_v672_%RANDOM%"
...
echo.
echo  ============================================================
echo    v6.72.0 INSTALADA  -  CICLO 11
echo.
