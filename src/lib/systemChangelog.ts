...
export const SYSTEM_CHANGELOG: SystemRelease[] = [
  {
    version: 'v8.9.5 Auditoría Integral y Blindaje de Seguridad y Datos',
    date: '20 de Agosto de 2026',
    time: '09:15 PM',
    summary: 'Auditoría integral: blindaje en reglas de Storage, sincronización de XML en Cloud Functions, desbloqueo de saldo $0.00 en Dashboard, normalización en Caja Chica y migración segura en espejo',
    highlights: [
      'Reglas de Storage Blindadas: verificación de email estricta, soporte para Custom Claims y exclusión de cuentas no revocables en Storage.',
      'Sincronización XML en Backend: corrección de invoiceStatuses en la ingesta automática de CFDI en Cloud Functions.',
      'Calibración Financiera Desbloqueada: el Dashboard ahora respeta $0.00 como valor deliberado y legítimo de deuda histórica con Andrés.',
      'Normalización de Nombres en Caja Chica: unificación con normalizarTexto() para evitar discrepancias por acentuación ("Andrés" vs "Andres").',
      'Migración Espejo Segura: MigrationTools convertida a sincronización idempotente hacia la colección invoices sin destruir los datos originales de purchaseOrders.',
      'Blindaje Matemático: 72/72 pruebas unitarias, build de producción y Cloud Functions al 100%.',
    ],
  },
  {
