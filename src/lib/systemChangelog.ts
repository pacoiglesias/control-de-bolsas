...
export const SYSTEM_CHANGELOG: SystemRelease[] = [
  {
    version: 'v8.9.6 Auditoría de Seguridad e Integridad de Datos',
    date: '21 de Agosto de 2026',
    time: '02:00 PM',
    summary: 'Se implementaron los 3 niveles aprobados de la auditoría del sistema: los 2 hallazgos críticos, integridad de datos y rendimiento/pruebas',
    highlights: [
      'Borrado Seguro en Auditoría: "Purgar Duplicados" y "Archivar" en la pantalla de Auditoría ya no borraban de forma permanente ni verificaban el rol -- ahora archivan (recuperable, como la Papelera) y solo un administrador puede hacerlo, con registro en el log.',
      'Caja Chica Ya No Es Pública: el saldo real de efectivo se movió del documento público que necesita leer la pantalla de Login a uno privado, protegido igual que el PIN del Portal Maquilador.',
      'Saldo con Andrés, Ahora en un Solo Lugar: la fórmula que causó el bug de v8.9.4 vivía copiada tres veces (Dashboard, Compras -> Andrés, y el Portal Maquilador) -- se unificó en una sola función compartida, con 8 pruebas nuevas que la protegen de volver a divergir.',
      'Un Hook Fantasma Archivado: dos funciones con el mismo nombre exacto convivían en el proyecto, una de ellas sin usar -- se archivó (no se borró) para quitar el riesgo de que alguien la edite por error pensando que es la real.',
      'Configuración Real en Vez de Valores Fijos: el motor de estadísticas del Dashboard ya lee el costo por kilo y la comisión configurados en vez de usar 42/8% fijos sin importar lo que el usuario haya ajustado.',
      'Escrituras Más Seguras: Facturación Rápida y Asignar Contrarecibo ahora usan transacciones, para no perder cambios si dos personas trabajan sobre el mismo expediente al mismo tiempo.',
      'Catálogo y Lista de Precios Protegidos: borrar esos catálogos ahora requiere el nivel más alto de permiso, igual que ya pasa con expedientes, facturas y el libro mayor.',
      'Carga Más Ligera: las pantallas que exportan a Excel ya no descargan esa librería (429 KB) hasta que realmente se usa.',
      'Blindaje Matemático: 80/80 pruebas unitarias (8 nuevas), typecheck y lint limpios en frontend y backend, compilación de producción completa sin errores.',
    ],
  },
  {
    version: 'v8.9.5 Menú Lateral Renovado: Íconos Reales, Nombres Más Claros y Alertas con Sonido',
    date: '20 de Agosto de 2026',
    time: '11:30 PM',
    summary: 'El menú lateral completo dejó los emojis por íconos reales, se renombraron 2 secciones para sonar más profesional, y el sistema ahora avisa con un sonido suave cuando aparece una alerta nueva mientras trabajas',
    highlights: [
      'Menú Lateral con Íconos Reales: el rediseño visual de v8.9.3 solo había cubierto Dashboard y Portal Maquilador -- ahora el menú lateral completo usa el mismo set de íconos de trazo simple, incluyendo la corrección de dos íconos que se repetían por accidente (💵 y ⚖️ usados dos veces cada uno).',
      'Nombres Más Claros: "Métricas & Data Mining" ahora es "Métricas y Reportes", y "Portal Proveedor / Báscula" ahora es "Portal del Proveedor (Báscula)".',
      'Alerta Proactiva con Sonido: si aparece un contrarecibo vencido, una entrega de Andrés lista para facturar o una factura sin CR nuevos mientras tienes el sistema abierto, ahora suena un aviso suave -- solo cuando el número de pendientes sube, nunca al abrir la app.',
      'Una Sola Fuente de Verdad para las Alertas: el cálculo de alertas proactivas se centralizó en un solo lugar compartido por la campanita de notificaciones y el nuevo aviso sonoro, para no repetir el mismo tipo de error que causó el bug del Saldo con Andrés en v8.9.4.',
      'Instalador Atrapó un Faltante Antes de Producción: el primer intento de instalar este parche falló su propio typecheck porque Cobranza, Caja Chica, Compras y Expedientes ya usaban 6 íconos (y una opción de color) que el set de íconos todavía no tenía definidos -- se completaron y se volvió a verificar todo contra los archivos reales antes de tocar producción.',
      'Blindaje Matemático: 72/72 pruebas unitarias, typecheck y lint limpios en frontend y backend, y compilación de producción completa sin errores.',
    ],
  },
  {
    version: 'v8.9.4 CRÍTICO: "Saldo con Andrés" Corregido -- Dashboard y Compras Ya Coinciden',
    date: '20 de Agosto de 2026',
    time: '08:30 PM',
    summary: 'El Dashboard mostraba -$1,289,709.62 en "Saldo con Andrés" mientras Compras -> Andrés mostraba +$40,800.00 para el mismo dato -- una diferencia de $1,330,509.62 causada por un campo de configuración que el Dashboard nunca leía',
    highlights: [
      'Fuente Única de Verdad Restaurada: el cálculo del Dashboard no leía el ajuste de deuda histórica configurado en Ajustes y usaba en su lugar un valor fijo de hace semanas -- ahora lee exactamente el mismo dato que ya usa correctamente Compras -> Andrés.',
      'Reportado y Corregido en Vivo: encontrado revisando producción tras el aviso directo del usuario de que el número se veía irreal.',
      'Blindaje Matemático: 72/72 pruebas unitarias y typecheck limpios en frontend y backend.',
    ],
  },
  {
    version: 'v8.9.3 Rediseño Visual: Íconos Reales y Enfoque en lo Importante',
    date: '20 de Agosto de 2026',
    time: '04:00 PM',
    summary: 'Íconos reales en vez de emojis en Dashboard y Portal Maquilador, barra de Kilos más clara, tarjeta de Efectivo en Caja destacada y botones táctiles ajustados en el Portal Maquilador',
    highlights: [
      'Íconos Reales en las Pantallas de Mayor Uso: reemplazo de emojis por un set de íconos de trazo simple hechos a mano (sin agregar ninguna librería nueva) en las 4 tarjetas del Dashboard y en el encabezado/pestañas del Portal Maquilador.',
      'Barra de Kilos Entregados Más Clara: casi el doble de gruesa, con el porcentaje encimado directo sobre el relleno en vez de vivir aparte.',
      'Tarjeta "Efectivo en Caja" Destacada: ahora abre la fila de indicadores del Dashboard, con el doble de ancho y una cifra más grande que las demás.',
      'Portal Maquilador Pensado para el Taller: botones de Actualizar/Salir y las 3 pestañas de navegación ajustados a 44px, el mínimo recomendado para un toque cómodo con el dedo en movimiento.',
      'Blindaje Matemático: 72/72 pruebas unitarias, typecheck y lint limpios en frontend y backend.',
    ],
  },
  {
    version: 'v8.9.2 Auditoría de Seguridad y Blindaje contra Borrado de Datos',
    date: '20 de Agosto de 2026',
    time: '02:00 PM',
    summary: 'Auditoría completa de 6 frentes: se quitó un borrado automático y permanente de expedientes oculto en "Recalcular Indicadores", se cerraron 4 huecos de seguridad y se corrigió la consistencia visual del Kanban',
    highlights: [
      'CRÍTICO — Borrado Oculto Eliminado: "Recalcular Indicadores" tenía, contradiciendo su propio comentario de código, un bloque que borraba de forma permanente cualquier expediente fuera de una lista fija de 10 contrarecibos. Se quitó por completo: la función ya nunca borra nada.',
      'Acceso de Administrador Irrevocable Corregido: cualquier correo del dominio corporativo era super-admin automático y no se le podía revocar el acceso desde Usuarios. Ahora solo las 2 cuentas del dueño tienen ese nivel.',
      'PIN del Portal Maquilador Protegido: bloqueo de 15 minutos tras 5 intentos fallidos seguidos, y ya no existe un PIN de respaldo si la configuración no está lista.',
      'Cierre de 2 Huecos de Sesión Anónima: dos reglas de Firestore (gastos y bitácora de errores) aceptaban cualquier sesión, incluida una anónima creada desde la consola del navegador.',
      'Kanban Alineado con el Resto del Sistema: la columna "Con el Contador" ya no se ve verde (como si estuviera resuelta) — ahora usa el mismo ámbar que el resto de las pantallas, y saltar varios pasos de un jalón pide confirmación.',
      'Blindaje Matemático: 72/72 pruebas unitarias, typecheck y lint limpios.',
    ],
  },
  {
    version: 'v8.9.1 Claridad en los Avisos de Facturas Vencidas',
    date: '20 de Agosto de 2026',
    time: '12:00 PM',
    summary: 'El banner rojo y la tarjeta "Urgencias (Vencido)" del Dashboard mostraban números distintos sin explicar por qué',
    highlights: [
      'Redacción Explícita de Cada Aviso: el banner ahora aclara que solo cuenta lo que acaba de vencer, y la tarjeta aclara que muestra el acumulado total a la fecha — ya no parece que uno de los dos esté mal.',
    ],
  },
  {
    version: 'v8.9.0 Logo e Íconos Oficiales Unificados',
    date: '20 de Agosto de 2026',
    time: '10:00 AM',
    summary: 'Unificación de 4 versiones distintas del logo e íconos regadas en el proyecto -- una de ellas rota -- alrededor del sello "ED" real en denim',
    highlights: [
      'Ícono de Pestaña del Navegador Corregido: era una captura de pantalla de una tabla guardada por accidente con el nombre de logo -- reemplazado por el sello "ED" real recortado.',
      'Ícono de la App (PWA / "Agregar a Inicio") Rediseñado: antes era un ícono genérico de bolsas verde/azul sin relación con la marca; ahora usa el mismo sello "ED" en textura denim.',
      'Logo Grande de Ajustes sin Cambios: el logo.jpg que se sube desde Ajustes y ya se ve en vivo no se tocó.',
      'Respaldo Automático: los 4 archivos anteriores se guardaron antes de reemplazarlos.',
    ],
  },
  {
    version: 'v8.8.9 Portal Maquilador: Bitácora de Entregas y Cierre de Hueco de Seguridad',
    date: '19 de Agosto de 2026',
    time: '09:00 PM',
    summary: 'Nueva función en el servidor para validar el PIN antes de guardar entregas, bitácora de lo registrado desde el portal y Estado de Cuenta corregido',
    highlights: [
      'Entregas Validadas en el Servidor: nueva función registrarEntregaMaquila valida el PIN antes de escribir, cerrando un hueco donde cualquiera podía registrar entregas falsas con una sesión anónima sin conocer el PIN real.',
      'Bitácora de Portal Maquilador: cada entrega registrada (en línea o sincronizada desde Modo Taller offline) queda anotada en la Bitácora del sistema.',
      '"Mi Estado de Cuenta" Corregido: mostraba $0.00 pese a haber compras y pagos reales por un problema de acentos al comparar el nombre del proveedor.',
    ],
  },
  {
    version: 'v8.8.8 Kanban y Cobros Rápidos: Escrituras Protegidas con Transacción',
    date: '19 de Agosto de 2026',
    time: '07:00 PM',
    summary: 'El Kanban, Deshacer en Contrarecibos/Caja Chica y los cobros rápidos escribían sobre una copia en memoria en vez de releer el dato real, arriesgando pisarse entre sí',
    highlights: [
      'Kanban con Transacción: mover una tarjeta ya relee el expediente real antes de escribir y nunca vuelve a tocar una factura que ya esté cobrada.',
      'Deshacer Protegido: en Contrarecibos y Caja Chica, "Deshacer" ya no sobrescribe el documento completo -- solo revierte el campo exacto que cambió.',
      'Cobro Rápido y Asignar Contrarecibo con el Mismo Blindaje: ambos releen el expediente real antes de guardar.',
    ],
  },
  {
    version: 'v8.8.7 Portal Maquilador: Sesión Real para que las Entregas SÍ Lleguen',
    date: '19 de Agosto de 2026',
    time: '05:00 PM',
    summary: 'El PIN validaba correctamente pero nunca abría una sesión real, así que las entregas y gastos podían fallar en silencio, sobre todo en Modo Taller offline',
    highlights: [
      'Sesión Anónima Real tras Validar el PIN: corrige un fallo silencioso donde el "Modo Taller" offline decía "Guardado localmente" pero la entrega nunca llegaba a sincronizar de verdad.',
    ],
  },
  {
    version: 'v8.8.6 Revisión de Hallazgos Externos: 1 Bug Real, 3 Descartados',
    date: '19 de Agosto de 2026',
    time: '03:00 PM',
    summary: 'Revisión punto por punto de una lista externa de posibles hallazgos: se confirmó y corrigió 1 bug real, se descartaron 3 falsos positivos y se hicieron 3 limpiezas menores',
    highlights: [
      '"Recibir en Caja" Corregido: pasaba una configuración vacía que funcionaba de chiripa por los valores ya guardados en la factura -- una factura vieja sin esos datos podía fallar. Ya pasa la configuración real.',
      'Limpieza de Tipos y Código: varios archivos con tipos genéricos innecesarios y condiciones redundantes simplificados.',
      '3 Hallazgos Descartados tras Revisión a Fondo: confirmado que no eran bugs reales en el código actual.',
    ],
  },
  {
    version: 'v8.8.5 Pulido Funcional: Doble-Clic, Confirmaciones, Búsqueda y Fechas',
    date: '19 de Agosto de 2026',
    time: '01:00 PM',
    summary: 'Seis correcciones operativas encontradas en revisión directa: duplicados por doble clic, cambios de rol sin confirmar, bitácora a medias, formato de fechas y búsqueda faltante en Catálogo',
    highlights: [
      '"Recibir en Caja" ya no se duplica con doble clic en conexiones lentas.',
      'Cambiar el rol de un usuario ahora pide confirmación, igual que "Revocar Acceso".',
      '"Limpiar Bitácora" ya vacía por completo en vez de dejar registros a medias.',
      'Fechas en correos y remisiones impresas ya usan siempre el formato mexicano del resto del sistema.',
      'Catálogo de Productos con Buscador Nuevo por descripción o código.',
    ],
  },
  {
    version: 'v8.8.4 Auditoría de Consistencia: Comisión, Estatus y Blindaje de Cálculos',
    date: '19 de Agosto de 2026',
    time: '11:00 AM',
    summary: 'Comisión de respaldo del contador corregida a 8%, estatus "facturado" agregado al backend y Corte Semanal alineado con el resto del sistema',
    highlights: [
      'Comisión de Respaldo Corregida: el backend usaba 6.9% en vez de 8% cuando una factura importada no traía la comisión capturada -- ya coincide con la vista en vivo.',
      'Estatus "Facturado" en el Backend: al cálculo de KPIs del Dashboard le faltaba esa rama, y podía hacer desaparecer expedientes activos de los contadores.',
      'Corte Semanal Alineado: ya usa el mismo criterio de kilos (desglose por producto primero) que el resto de las pantallas.',
    ],
  },
  {
    version: 'v8.8.3 Estación del Pedido Sincronizada en 5 Pantallas',
    date: '19 de Agosto de 2026',
    time: '09:00 AM',
    summary: 'Pedidos ya facturados y con Contrarecibo se seguían mostrando como "En Producción" en 5 pantallas que recalculaban kilos a mano en vez de usar la fuente única del sistema',
    highlights: [
      'Unificación bajo getOrderSummary(): Seguimiento de Pedidos, Pipeline de Dinero, Radar de Acciones, Vista Rápida y Kanban de Entregas ya usan la misma fuente que la barra "100% Surtido", corrigiendo la etapa mostrada de varios expedientes reales.',
    ],
  },
  {
    version: 'v8.8.2 Arquitectura Offline-First y Seguridad Moderna',
    date: '18 de Agosto de 2026',
    time: '07:00 PM',
    summary: 'Detección de conexión en tiempo real con sincronización automática, reglas de seguridad modernizadas con Custom Claims y modularización del Dashboard',
    highlights: [
      'Resiliencia Offline: detección en tiempo real de pérdida/recuperación de internet, con sincronización automática de la cola de entregas del Portal Maquilador al reconectar.',
      'Seguridad Modernizada: reglas de Firestore desacopladas de correos fijos a favor de Custom Claims y verificación estricta de roles.',
      'Modularización del Dashboard: modales y drawers satélite aislados en un módulo propio, aligerando el sistema.',
    ],
  },
  {
    version: 'v8.8.1 Fix: Kanban Desincronizaba el Estatus de Facturas',
    date: '18 de Agosto de 2026',
    time: '05:30 PM',
    summary: 'Mover tarjetas en el Kanban dejaba el estatus interno desnormalizado, invisible para la detección automática de vencidas',
    highlights: [
      'Escritura Corregida en el Kanban: ahora recalcula el estatus normalizado que usa el barrido nocturno de facturas vencidas, igual que ya hacía el resto del sistema.',
      'Generadores de Reportes HTML Modularizados: plantillas pesadas de Dashboard, Portal Maquilador y Cobranza extraídas a archivos propios.',
    ],
  },
  {
    version: 'v8.8.0 Auditoría Maestra: Precisión Financiera Total',
    date: '18 de Agosto de 2026',
    time: '04:00 PM',
    summary: 'Eliminación total de parseo y formateo manual disperso en el sistema, consolidación completa del Dashboard, Cobranza y PDFs financieros',
    highlights: [
      'Cero Residuos de Parseo y Formateo: sustitución universal de cálculos ad-hoc por los formateadores y parser estándar del sistema en más de una docena de pantallas.',
      'Consolidación Financiera Completa: Radar de Acciones, Proyección de Flujo, Semáforo del Día, Estado de Cuenta y Cédulas PDF blindados contra nulos y con redondeo exacto.',
      'Blindaje Matemático: 72/72 pruebas aprobadas, desplegado en vivo.',
    ],
  },
  {
    version: 'v8.7.3 Rendimiento, Accesibilidad y Determinismo Financiero',
    date: '18 de Agosto de 2026',
    time: '02:30 PM',
    summary: 'Formateadores de dinero pre-instanciados, accesibilidad WCAG-AA en el Kanban y blindaje contra nulos en fechas, búsqueda y captura numérica',
    highlights: [
      'Formateadores Memoizados: dinero y kilos pre-instanciados para acelerar el renderizado de listas largas de expedientes y facturas.',
      'Accesibilidad WCAG-AA: botones táctiles ampliados a 44x44px y respuesta háptica en el scroll del Kanban.',
      'Blindaje contra Nulos: ordenamiento cronológico, búsqueda global y captura de dinero protegidos contra datos históricos incompletos.',
    ],
  },
  {
    version: 'v8.7.2 Fix: Pantalla en Blanco al Cambiar entre TH y GT',
    date: '18 de Agosto de 2026',
    time: '01:00 PM',
    summary: 'Una suscripción a documentos de Firestore que nunca existieron causaba pantalla en blanco al alternar el filtro departamental',
    highlights: [
      'Listener Corregido: fijado al documento oficial de estadísticas, calculando las métricas por departamento en vivo en vez de leer documentos inexistentes.',
      'Blindaje contra Nulos: verificaciones de seguridad agregadas en 5 paneles del Dashboard, más un ErrorBoundary modular que aísla cualquier falla futura.',
    ],
  },
  {
    version: 'v8.7.1 Filtro Departamental Hermético y Rediseño de Configuración',
    date: '18 de Agosto de 2026',
    time: '11:30 AM',
    summary: 'Resuelta una colisión de nombres que reclasificaba facturas de Textil Hogar como Grupo Textil, y rediseño del Centro de Control',
    highlights: [
      'Filtro TH/GT Determinista: prioridad estricta a prefijos de contrarecibo y folio sobre el nombre completo de la razón social.',
      'Centro de Control Rediseñado: 3 tarjetas ejecutivas (Identidad, Cliente Principal con Plantas TH/GT, Taller Fabricante) 100% configurables.',
      'Conciliación Oficial de Cartera: 10 Contrarecibos Oficiales por $1,019,956.34 (TH $584,400.42 / GT $435,555.92), cuadrados contra el estado de cuenta real.',
    ],
  },
  {
    version: 'v8.7.0 Suite de Lujo: Spotlight, Motor Háptico y Personalización Universal',
    date: '18 de Agosto de 2026',
    time: '10:00 AM',
    summary: 'Buscador global estilo Raycast, panel de vista rápida, motor de sonido y vibración hápticos, y sistema parametrizable para cualquier empresa o taller',
    highlights: [
      'Spotlight Universal (Ctrl+K): buscador global con navegación táctil y catálogo de acciones directas.',
      'Smart Quick-Peek Drawer: panel lateral ultra-rápido para previsualizar avance de kilos, facturas y cobro en 1 toque.',
      'Motor Háptico y de Sonido: síntesis de audio offline y vibraciones para pantallas táctiles.',
      'Parametrización Universal: nombres de empresa, cliente, taller y departamentos desacoplados del código, configurables desde Ajustes.',
    ],
  },
  {
