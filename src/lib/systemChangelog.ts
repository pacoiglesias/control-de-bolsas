import { LATEST_RELEASE, type SystemRelease } from './latestRelease';
...
export const SYSTEM_CHANGELOG: SystemRelease[] = [
  LATEST_RELEASE,
  {
    version: 'v9.7.0 Enterprise: Centinela Continuo en Vivo, Dial de Salud ERP y Directiva Staff Engineer v2.0',
