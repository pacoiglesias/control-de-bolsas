...
import { IconFactory, IconWallet, IconClipboardList, IconRefresh, IconLogout } from '../components/ui/icons';
      ...
      <div style={{ maxWidth: 620, margin: '0 auto' }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <IconFactory size={32} style={{ color: '#a78bfa' }} />
            <div>
              <div
                style={{
                  fontSize: 11,
          ...
          {/* FIX (v8.9.3): estos dos botones median ~36px de alto (padding
              8px + texto) -- por debajo del minimo de 44px que recomienda
              Apple/Android para un dedo en movimiento, justo los dos botones
              que Andrés toca parado en el taller, no sentado con mouse.
              minWidth/minHeight 44 los deja del tamaño correcto sin cambiar
              como se ven. */}
        ...
        >
          {(
            [
              ['entrega', IconFactory, 'Registrar Entrega'],
              ['estado', IconWallet, 'Mi Estado de Cuenta'],
              ['historial', IconClipboardList, `Historial (${historial.length})`],
            ] as const
          ).map(([k, TabIcon, l]) => (
            <button
              key={k}
