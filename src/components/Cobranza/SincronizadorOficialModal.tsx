...
export const OFFICIAL_CRS: OfficialCrRecord[] = [
  ...
  },
  {
    ...
    status: 'GENERADO',
    department: 'TH',
    invoicesDetails: [{ folio: '6198', amount: 98054.60 }],
  },
  {
    no: 10,
    cr: 'TH-946',
    ...
    status: 'VENCIDO',
    department: 'TH',
    invoicesDetails: [{ folio: '6167', amount: 81780.00 }],
  },
];

export const OFFICIAL_PAID_CRS: OfficialCrRecord[] = [
  { no: 1,  cr: 'TH-912', issueDate: '2026-08-10', dueDate: '2026-09-09', total: 79826.00, status: 'PAGADO', department: 'TH', invoicesDetails: [{ folio: '6159', amount: 79826.00 }] },
  { no: 2,  cr: 'TH-879', issueDate: '2026-08-03', dueDate: '2026-09-02', total: 136300.00, status: 'PAGADO', department: 'TH', invoicesDetails: [{ folio: '6097 6098', amount: 136300.00 }] },
  { no: 3,  cr: 'TH-836', issueDate: '2026-07-27', dueDate: '2026-08-26', total: 106720.17, status: 'PAGADO', department: 'TH' },
  { no: 4,  cr: 'GT-742', issueDate: '2026-07-20', dueDate: '2026-08-19', total: 54520.00, status: 'PAGADO', department: 'GT', invoicesDetails: [{ folio: '6073', amount: 54520.00 }] },
  { no: 5,  cr: 'TH-804', issueDate: '2026-07-20', dueDate: '2026-08-19', total: 136300.00, status: 'PAGADO', department: 'TH' },
  { no: 6,  cr: 'GT-713', issueDate: '2026-07-13', dueDate: '2026-08-12', total: 69001.60, status: 'PAGADO', department: 'GT', invoicesDetails: [{ folio: '6053', amount: 69001.60 }] },
  { no: 7,  cr: 'TH-768', issueDate: '2026-07-13', dueDate: '2026-08-12', total: 125254.25, status: 'PAGADO', department: 'TH' },
  { no: 8,  cr: 'TH-739', issueDate: '2026-07-06', dueDate: '2026-08-05', total: 109040.00, status: 'PAGADO', department: 'TH' },
  { no: 9,  cr: 'GT-651', issueDate: '2026-06-29', dueDate: '2026-07-29', total: 106477.56, status: 'PAGADO', department: 'GT', invoicesDetails: [{ folio: '5971', amount: 106477.56 }] },
  { no: 10, cr: 'TH-713', issueDate: '2026-06-29', dueDate: '2026-07-29', total: 108647.46, status: 'PAGADO', department: 'TH' },
];

export const OFFICIAL_IN_REVIEW = [
  { folio: '6302', oc: '12026439774', client: 'GRUPO TEXTIL PROVIDENCIA (GT - EVELIA / P4)', total: 14864.24, department: 'GT' as const, dateStr: '2026-09-22', kilos: 298.00, uuid: 'FFD7964A-BD1E-4332-AEA9-61E3F498521C' },
  { folio: '6307', oc: '120267114302', client: 'GRUPO TEXTIL PROVIDENCIA (TH - JOSÉ NAVA)', total: 99061.68, department: 'TH' as const, dateStr: '2026-09-24', kilos: 1986.00, uuid: '67F11BC8-7B33-4CFC-97EE-0AA45F51F797' },
];
