  ...
  return (
    <div style={{ display: 'flex', gap: 16, marginBottom: 32, flexWrap: 'wrap' }}>
      <motion.button 
        ...
        style={{ padding: '16px 24px', fontSize: 16, borderRadius: 16, display: 'flex', alignItems: 'center', gap: 8, boxShadow: '0 10px 20px -10px var(--brand)' }}
        onClick={onNewOrder}
      >
        <span style={{ fontSize: 20 }}>➕</span> Nuevo Expediente
      </motion.button>
      ...
      {role !== 'viewer' && (
        ...
        >
          <span style={{ fontSize: 20 }}>📆</span> Vencimientos (CR)
        </motion.button>
      )}
