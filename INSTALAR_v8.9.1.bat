...
title Control Bolsas - Instalar parche v8.9.1
color 0B
cls
echo.
echo  ============================================================
echo    INSTALAR PARCHE v8.9.1
echo    Dashboard: aclara los dos avisos de "vencido" que parecian
echo    el mismo dato (banner rojo vs tarjeta Urgencias).
echo  ============================================================
echo.
cd /d "%~dp0"

set "ZIPFILE=PARA-CLAUDE_parche_v8_9_1.zip"
...
set "TMPEXTRACT=%TEMP%\cb_patch891_%RANDOM%"
...
robocopy "%TMPEXTRACT%\patch891" "%~dp0." /E /IS /IT >nul
...
echo.
echo  ============================================================
echo    LISTO. v8.9.1 instalada.
echo    Este parche es solo texto/UI -- necesita build + deploy de
echo    hosting para verse en produccion (no toca reglas ni
