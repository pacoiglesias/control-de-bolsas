...
**Estado:** 🟡 En curso. Código corregido, verificado y committeado (v7.0.19). Pendiente en producción: (1) terminar de fusionar 6097+6098 en un solo expediente con el CR TH-879 real usando ahora el flujo corregido, (2) decidir con el usuario qué hacer con el expediente TH-804 duplicado/mal etiquetado (no se toca sin su autorización explícita), (3) capturar las 2 facturas restantes que faltan por el lado de "En Revisión sin CR" (folios 6167 y 6159) una vez resuelto lo anterior.
